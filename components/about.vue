<template>
  <footer class="text-center bg-transparent text-white">
    <div class="container px-6 mt-64">
    ...
    <div class="text-center p-4 bg-transparent">
      © 2023 Copyright:
      <a class="text-whitehite" href="https://tailwind-elements.com/">R</a>
    </div>
  </footer>
